...
const { AWS, SMTP, WEB_URL, ADMIN_WEB_URL, ENVIRONMENT, LIVE_LOGGER_ENABLE } = require('../../config');
...
//             case CONSTANTS.EMAIL_TYPES.RESET_PASS_EMAIL: 
//             EmailStatus['Subject'] = CONSTANTS.EMAIL_SUBJECTS.PASSWORD_RESET;
//             EmailStatus.template = CONSTANTS.EMAIL_CONTENTS.PASSWORD_RESET;
//             EmailStatus.data.user = user.userName || "user";
